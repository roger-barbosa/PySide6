...
class PyPushButton(QPushButton):
    def __init__(
        ...
        super().__init__()  # Executa o super construtor da classe herdada, no caso QPushButton
        ...
        # Custom parameters
        self.minimum_with = minimum_with
    ...
    def paintEvent(self, event):
        ...
        qp.setPen(Qt.NoPen)  # Define icone sem borda

        rect = QRect(0, 0, self.minimum_with, self.height())
